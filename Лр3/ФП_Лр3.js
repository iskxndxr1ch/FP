...
const numbers = [3, 6, 9, 10, 12, 15, 20, 24];
// Пример массива строк
const words = ["TypeScript", "JavaScript", "Функциональное программирование"];
...
console.log("Результат вызова функции с логированием:", loggedGetMultiplesOf(numbers, 6));
export {};
